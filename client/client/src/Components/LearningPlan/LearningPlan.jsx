    ...
    <div className="p-8">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold flex items-center">
          <BookOutlined className="mr-2" /> My Fitness Plans
        </h1>
        <Button
          type="primary"
          icon={<PlusOutlined />}
      ...
      {learningPlan.plans?.length === 0 ? (
        <div className="text-center py-10 border-2 border-dashed rounded-lg">
          ...
          <p className="text-lg text-gray-600">No fitness plans yet</p>
          <Button 
            type="primary" 
            className="mt-4"
            onClick={() => showPlanModal()}
              ...
              <Panel 
                header={
                  <div className="flex justify-between items-center">
                    ...
                    <div>
                      <Tag color="blue">{plan.topics?.length || 0} Items</Tag>
                    </div>
                  </div>
                }
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white p-4 rounded-lg shadow">
                  ...
                  {selectedPlan.topics?.length > 0 ? (
                    ...
                    <p className="text-gray-500">No items to track progress</p>
                  )}
                </div>
      ...
      <Modal
        title={planModal.mode === 'create' ? 'Create Fitness Plan' : 'Edit Fitness Plan'}
